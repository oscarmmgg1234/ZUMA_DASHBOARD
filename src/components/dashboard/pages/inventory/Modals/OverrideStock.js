  ...
  const tableRows = filteredProducts.map((product, index) => (
    ...
    >
      ...
      <td className="px-4 py-2 border text-black">
        {inventoryMap.get(product.PRODUCT_ID).STORED_STOCK.toFixed(2)}
      </td>
      <td className="px-4 py-2 border text-black">
        {inventoryMap.get(product.PRODUCT_ID).ACTIVE_STOCK.toFixed(2)}
      </td>
    </tr>
  ));
        ...
        <div className="h-full w-full">
          ...
          >
            ...
            <p className="font-bold">
              {action ? "Storage Stock" : "Active Stock"}
            </p>
          </button>
          <div className="flex flex-1 justify-center items-center">
            <div className="p-6 bg-white rounded-lg shadow max-w-2xl w-full">
              ...
              <label className="mt-5 mr-5 text-black ">
                Quantity to Add or Delete:{" "}
              </label>
              <input
                type="text"
                value={quantity}
