...
const Employee = () => {
    ...
    <>
      ...
      {manageEmployeeModal && (
        <>
          ...
          <div className="h-[75vh] w-full p-6 overflow-y-auto">
  {/* Employee Table */}
    ...
    <table className="min-w-full divide-y divide-gray-200 text-sm">
      ...
      <tbody className="divide-y divide-gray-100">
        ...
        {!showAddForm ? (
          ...
          <tr>
            <td colSpan={4}>
              <div className="p-4 bg-gray-50 rounded-b-md space-y-3">
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    ["Location ID", employeeLocation, setEmployeeLocation],
                  ].map(([label, value, setFn], idx) => (
                    <div key={idx}>
                      <label className="block text-sm text-gray-600">{label}</label>
                      <input
                        className="w-full px-3 py-2 mt-1 border rounded-md text-sm focus:ring focus:ring-blue-300"
                        value={value}
  ...
  {confirmDelete && (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-md text-center space-y-4 w-[90%] max-w-sm">
        <p className="text-gray-800">Are you sure you want to delete this employee?</p>
