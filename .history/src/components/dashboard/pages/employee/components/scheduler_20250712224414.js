...
const processShiftChanges = async (
  ...
  for (const date in shiftData) {
    ...
    if (current.SHIFT_START !== original.SHIFT_START) {
        console.log("SHIFT_START changed:", date, current.SHIFT_START, original.SHIFT_START);
...
const CustomDateCellWrapper = ({ children, value }) => {
 ...
 return (
   <div style={{ height: "62vh", color: "black" }}>
     ...
     />
     <button
       style={{ marginRight: "50vh",marginTop: "1rem", padding: "0.5rem 1rem", backgroundColor: "#007bff", color: "white", border: "none", borderRadius: "4px", cursor: "pointer" }}
       onClick={() => {
