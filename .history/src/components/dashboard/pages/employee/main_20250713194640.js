...
const Employee = () => {
  ...
  <table className="min-w-full table-fixed text-sm">
    <thead className="bg-gray-200 sticky top-0 z-10">
      <tr>
        <th className="px-4 py-2 border w-1/4 text-left">Employee Name</th>
        <th className="px-4 py-2 border w-1/4 text-left">Employee ID</th>
        <th className="px-4 py-2 border w-1/4 text-left">Employee Title</th>
        <th className="px-2 py-2 border w-1/4 text-center">Actions</th>
      </tr>
    </thead>
    <tbody>
      {/* ✅ Existing tableRows */}
