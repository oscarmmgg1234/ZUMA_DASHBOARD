    ...
    <div className="p-6 bg-white rounded-lg shadow max-w-2xl w-full">
      {action ? (
        ...
        <div className="flex flex-col space-y-4 text-black">
          {[
            ["Employee Full Name", employeeName, setEmployeeName, "Name"],
            ["Employee Email", employeeEmail, setEmployeeEmail, "Email Address"],
            ["Employee Phone", employeePhone, setEmployeePhone, "Phone#"],
            ["Employee Title", employeeTitle, setEmployeeTitle, "Title"],
            ["Employee Wage", employeeWage, setEmployeeWage, "Wage"],
            ["Location ID", employeeLocation, setEmployeeLocation, "Location# (4322)"],
        ...
        <>
          <div className="max-h-[400px] overflow-y-auto rounded border">
            <table className="min-w-full table-fixed text-sm text-black">
              <thead className="bg-gray-200 sticky top-0 z-10">
                <tr>
                  <th className="px-4 py-2 border w-1/3 text-left">Employee Name</th>
                  <th className="px-4 py-2 border w-1/3 text-left">Employee ID</th>
                  <th className="px-4 py-2 border w-1/3 text-left">Employee Title</th>
                  <th className="px-2 py-2 border w-12 text-center">Delete</th>
                </tr>
              </thead>
              <tbody>
          ...
          {clickedEmployee !== null && (
            <div className="mt-6 p-4 border border-red-300 bg-red-50 rounded-md text-black">
              <p className="mb-3 font-medium">Are you sure you want to delete this employee?</p>
        ...
        <ModalBackground onClick={() => handleModalClose("viewScheduler")} />
          <ModalContainer>
            <ModalHeader className="sticky top-0 z-10 bg-white">
              ...
              <ModalCloseButton onClick={() => handleModalClose("viewScheduler")}>
                <FaTimes className="w-5 h-5 mr-2" />
              </ModalCloseButton>
            </ModalHeader>
            <select
          ...
          <MyCalendar employee={scheduleEmployees.find(emp => emp.name === selectedEmployee)} />
          </ModalContainer>
        </>
      )
      }
