...
function treeToTokenEncoder(){
  ...
  //if only a product node and no children we discard dont add because we have no actions, if we have childs but no parent then we discard because he have no pro
  //work backwards
}
