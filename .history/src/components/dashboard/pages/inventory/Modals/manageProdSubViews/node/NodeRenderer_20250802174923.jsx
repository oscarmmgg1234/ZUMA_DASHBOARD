...
const onKeyDown = useCallback((e) => {
  ...
  return (
    <div style={{ width: '95%', height: '1000px', borderStyle: "solid", borderWidth: "9px", borderRadius: 4, borderColor:"rgba(7, 43, 64, 0.8)" }} tabIndex={0} onKeyDown={onKeyDown}>
      <ReactFlow
        nodes={rfNodes}
        edges={rfEdges}
      ...
      >
        <MiniMap/>
        <Background
  variant=""         // or 'lines' if you want lines instead
