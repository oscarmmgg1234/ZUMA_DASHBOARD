...
useEffect(()=>{
  if (!tree || !treeSnapshot || tree.length === 0 || treeSnapshot.length === 0) return;
  setInterval(()=>{if (!tree || !treeSnapshot || tree.length === 0 || treeSnapshot.length === 0) return;handleCommit(tree, treeSnapshot)}, 10000)
}, [])
