...
function treeToTokenEncoder(){
  ...
  //so example would be "AC:2wEdfd:04rf3s" since params where left empty if there is a param then :param1:param2 if param 2 is set we need to put 0 for first param eve
  //work backwards
}
