...
export default function EditProduct(props) {
  ...
  const [commitNodeChanges, setCommitNodeChanges] = useState(false);
  //reduction
  //shipment

const activateNodeChanges = () => {
  console.log("selectred node change buttion")
  setCommitNodeChanges(true)
  setTimeout(()=>{setCommitNodeChanges(false)}, 400)
};
      ...
      {selectedProduct && (
        <div className="mt-4">
          ...
          <NodeRenderer
            ...
            registry={registry}
            commitNodeChange={commitNodeChanges}
          />
          <button
            onClick={activateNodeChanges}
            className="w-full p-4 text-white rounded text-lg font-semibold mt-8 mb-40"
