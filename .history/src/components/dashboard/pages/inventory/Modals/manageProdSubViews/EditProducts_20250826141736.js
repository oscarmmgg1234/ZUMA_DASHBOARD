...
const runtimeTestHandler = async (productID) => {
  try {
    const data = await http.runtimeTest({ productID });
    console.log("Runtime Test Result:", data);
    // Optionally display success/failure feedback to the user
    alert("Runtime test executed. Check console for details.");
  } catch (err) {
        ...
        <div className="mt-4">
          ...
          <div className="mb-4 mt-4">
            ...
            <select
              ...
              className="w-full p-2 border border-gray-300 rounded text-black m-b-10"
            >
