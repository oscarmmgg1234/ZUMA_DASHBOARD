...
const onKeyDown = useCallback((e) => {
  ...
  return (
    <div style={{ position: 'relative', width: '95%', height: '800px', borderStyle: "solid", borderWidth: "7px", borderColor: "rgba(0, 28, 62, 0.75)", borderRadius: "" }} tabIndex={0} onKeyDown={onKeyDown}>
  {/* Save Button */}
  <button
    onClick={() => {
      const isValid = handleCommit(tree, treeSnapshot);
