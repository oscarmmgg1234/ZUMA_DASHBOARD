...
function treeToTokenEncoder(){
  ...
  //so example would be "AC:2wEdfd:04rf3s RD:2wEdfd:04rf3s" since params where left empty if there is a param then :param1:param2 we ned to put null for param1 then param2 we inset value
  //so in the tree we have parent node with product id so we insert that into all the child 
  //work backwards
}
